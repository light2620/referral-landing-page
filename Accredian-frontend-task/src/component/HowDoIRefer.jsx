...
export default function HowDowIRefer({ openReferralModel}){
    return <section className="w-full bg-blue-100 mt-10 flex flex-col justify-center py-15 lg:gap-10 items-center">
        <h1 className="text-5xl  font-semibold">How Do I <span className="text-blue-600">Refer</span></h1>
         <div>
         ...
         className="bg-blue-700 text-white text-2xl p-3 cursor-pointer rounded hover:shadow-2xl">
                Refer Now
         </button>
    </section>
}